  ...
  return (
    <div className="mx-5 bg-white shadow-md px-5 py-10 rounded-lg mb-5">
      ...
      <div className="flex justify-evenly mt-5">
        <button
          className="bg-green-600 hover:bg-green-800 cursor-pointer px-3 py-1 text-white font-bold rounded-md"
          onClick={() => setData(per)}
        >
          Editar
        </button>
        <button className="bg-red-900 hover:bg-red-600 cursor-pointer px-3 py-1 text-white font-bold rounded-md">
          Eliminar
        </button>
      </div>
    </div>
