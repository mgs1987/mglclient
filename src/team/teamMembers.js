var MEMBERSINFO = [
  {
    ...
    rol: "Partner",
    email: "pedromalmgreen@gmail.com",
    specialty: "Constitucional and Criminal Law",
    description:
      "Pedro Malm Green has over 10 years of experience in the Argentine justice system, where he progressed through all positions in the judicial career until assuming the role of Secretary of the Court. He graduated with honors as a lawyer from the University of Buenos Aires and holds a Master's degree in Public Policy from the University Torcuato Di Tella. He has served as an Assistant Professor of Criminal Law at the Security Institute of the City of Buenos Aires and as an Assistant Professor of International Human Rights Law at the University of Buenos Aires.",
    linkedin: "https://www.linkedin.com/in/pedromalmgreen/",
